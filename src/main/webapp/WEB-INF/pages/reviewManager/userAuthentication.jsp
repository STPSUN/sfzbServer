											...
											<div class="panel-heading">
												<form class="form-horizontal" role="form" onsubmit="return false;">
													...
													<div class="col-sm-2" style="width:230px;">
														<label class="control-label" style="width: 70px;float: left;">真实姓名：</label>
														<input type="text" class="form-control" style="width: 100px;float: left;margin-left:12px" id="realName" placeholder="真实姓名查询">
													</div>
...
<script src="<%=path%>/pages/reviewManager/userAuthentication.js"></script>
