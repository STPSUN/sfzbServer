											...
											<div class="panel-heading">
												<form class="form-horizontal" role="form" onsubmit="return false;">
													...
													<div class="col-sm-2" style="width:230px;">
														<label class="control-label" style="width: 70px;float: left;">团队名称：</label>
														<input type="text" class="form-control" style="width: 100px;float: left;margin-left:12px" id="teamName" placeholder="团队名称查询">
													</div>
		...
		<div class="modal-dialog" style="width:65%">
			<div class="modal-content">
				 <div class="modal-header">
			        ...
			        <h4 class="modal-title" >团队实名认证确认</h4>
			      </div>
				<div class="modal-body">
					<input type="text" class="form-control" style="display: none;" id="auditPassUserId" placeholder="">
					<input type="text" class="form-control" style="display: none;" id="auditPassTeamId" placeholder="">
					<p>
						申请团队实名认证资料核实正确，是否确认进行操作。
					</p>
				</div>
		...
		<div class="modal-dialog" style="width:65%">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<input type="text" class="form-control" style="display: none;" id="notApprovedTeamId" placeholder="">
					<p>
						 团队实名认证资料不通过
					</p>
					<div>
...
<script src="<%=path%>/pages/reviewManager/userTeamAuthentication.js"></script>
