											...
											<div class="panel-heading">
												<form class="form-horizontal" role="form" onsubmit="return false;">
													<div class="form-group" style="margin-bottom: 0;">
														<label class="col-sm-1 control-label" style="width:100px;">推送账号:</label>
														<div class="col-sm-2" style="width:170px">
															<input id="qryUserName" name="qryUserName" style="width:150px" type="text" class="form-control" placeholder="请输入推送账号">
														</div>
														<label class="col-sm-1 control-label" style="width:115px;">推送昵称:</label>
														<div class="col-sm-2" style="width:170px">
															<input id="qryNickName" name="qryNickName" style="width:150px" type="text" class="form-control" placeholder="请输入推送昵称">
														</div>
														<label class="col-sm-1 control-label" style="width: 8%;">推送时间:</label>
...
<script src="<%=path%>/pages/userManager/messageManager.js"></script>
