											...
											<div class="panel-heading">
												<form class="form-horizontal" role="form" onsubmit="return false;">
													<div class="form-group" style="margin-bottom: 0;">
														...
														<label class="col-sm-1 control-label" style="width: 9%;">雇主账号:</label>
														<div class="col-sm-3" style="width: 180px;">
															<input class="form-control" placeholder="搜索雇主账号" type="text" id="userKeyWordSea" >
														</div>
														
														<label class="col-sm-1 control-label" style="width: 8%;">处理状态:</label>
														<select class="form-control" id="adminReviewStateSea" style="width: 180px; float: left;margin-left:12px">
															<option value="">全部</option>
															<option value='0'>未处理</option>
															<option value='1'>拒绝质保</option>
															<option value='2'>同意质保</option>
														</select>
...
<!-- =================同意或者驳回=========================================== -->
		...
		<div class="modal-dialog ">
			<div class="modal-content">
				<div class="modal-header">
			        ...
			        <h4 class="modal-title" id="myModalLabel">同意质保</h4>
			     </div>
				<div class="modal-body">
					<form class="form-horizontal" role="form">
						...
						<div class="form-group">
							<label class="col-sm-2 control-label">核实原因</label>
							<div class="col-sm-8">
	...
	<!-- 查看操作人和原因 -->
	<div id="showAuditRejectionModal" class="bootbox modal fade" tabindex="-1" role="dialog">
		<div class="modal-dialog ">
			<div class="modal-content">
				<div class="modal-header">
			        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
			        <h4 class="modal-title" id="myModalLabel">查看质保处理</h4>
			     </div>
				<div class="modal-body">
					<form class="form-horizontal" role="form">
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input id="showRejectionUser" type="text" class="form-control" placeholder="" readonly="readonly">
							</div>
						</div>
						...
						<div class="form-group">
							<label class="col-sm-2 control-label">核实原因</label>
							<div class="col-sm-8">
								<textarea id="showRejectionReason" rows="4" class="form-control limited" maxlength="1000" placeholder="填写核实原因" readonly="readonly"></textarea>
							</div>
						</div>
				...
				<div class="modal-footer">
					<button data-bb-handler="cancel" type="button" id="" modal="showAuditRejectionModal" class="cancel btn btn-danger cancel">取消</button>
				</div>
			</div>
		</div>
	</div>
...
<script src="<%=path%>/pages/projectManager/warrantyManager.js"></script>
