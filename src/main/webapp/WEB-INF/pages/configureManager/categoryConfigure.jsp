											...
											<div class="panel-heading">
												<form class="form-horizontal" role="form" onsubmit="return false;">
													<div class="form-group" style="margin-bottom: 0;">
														<label class="col-sm-1 control-label" style="width:100px;">类别名称:</label>
														<div class="col-sm-2" style="width:170px">
															<input id="qryCategoryName" name="qryCategoryName" style="width:150px" type="text" class="form-control" placeholder="请输入类别名称">
														</div>
														...
														<div class="col-sm-2" style="float:right;">
															<button id="addCategory" class="btn btn-info btn-label-left myBtn">
																<i class="fa fa-pencil-square-o">&nbsp;</i> 新增类别
															</button>
														</div>
													</div>
												</form>
		...
		<div class="modal-dialog" style="width:50%">
			<div class="modal-content">
				 <div class="modal-header">
			        ...
			        <h4 class="modal-title" id="addModalLabel">新增类别</h4>
			      </div>
				<div class="modal-body">
					<form class="form-horizontal" role="form" id="showForm" onsubmit="return false;">
						<div class="form-group" >
							<label class="col-sm-3 control-label" style="text-align:left;">服务类别：</label>
							<div class="col-sm-9">
						        <input id="parentName" name="parentName" type="text" class="form-control" style="border-color:#fff;
										box-shadow:inset 1 0px 0px rgba(0,0,0,0.075);" readonly="readonly">
							</div>
							<label class="col-sm-3 control-label" style="text-align:left;">类别名称：</label>
							<div class="col-sm-9">
						        <input id="categoryName" name="categoryName" type="text" class="form-control" style="border-color:#fff;
										box-shadow:inset 1 0px 0px rgba(0,0,0,0.075);">
							</div>
							<label class="col-sm-3 control-label" style="text-align:left;">所需技能：</label>
							<div class="col-sm-12" id="abilityLists">
								<!-- 
								<div class="checkbox col-sm-3"><label title="技能111111111111111111111111111"><input type="checkbox" name="ability"><span style="display:block;margin-top:-3px;">技能1111111</span></label></div>
								 -->
							</div>
						</div>
					</form>
...
<script src="<%=path%>/pages/configureManager/categoryConfigure.js"></script>
