...
<link rel="stylesheet" type="text/css" href="<%=path%>/pages/common/IIInsomniaCtiyPicker/css/cityPicker.css">
													...
													<div class="form-group" style="margin-bottom: 0;">
														<div class="col-sm-2" style="float:left;">
															<button id="addAbility" class="btn btn-info btn-label-left myBtn">
																<i class="fa fa-pencil-square-o">&nbsp;</i> 添加包招城市
															</button>
														</div>
													</div>
												</form>
		...
		<div class="modal-dialog" style="width:50%">
			<div class="modal-content">
				 <div class="modal-header">
			        ...
			        <h4 class="modal-title" id="addModalLabel">添加包招城市</h4>
			      </div>
				<div class="modal-body">
					<form class="form-horizontal" role="form" id="showForm" onsubmit="return false;">
						<div class="form-group" >
							<label class="col-sm-2 control-label" style="width:150px;">城市名称:</label>
							<div class="col-sm-3" >
								<input class="form-control" type="text" id="cityChoice" style="width:200px">
								<input class="form-control" type="hidden" id="province" value="">
								<input class="form-control" type="hidden" id="city" value="">
							</div>
						</div>
					</form>
				</div>
...
<script src="<%=path%>/pages/configureManager/regionConfigure.js"></script>
<script src="<%=path%>/pages/assets/js/uploadPreview.js"></script>

<script type="text/javascript" src="<%=path%>/pages/common/IIInsomniaCtiyPicker/js/cityData.js"></script>
<script type="text/javascript" src="<%=path%>/pages/common/IIInsomniaCtiyPicker/js/cityPicker.js"></script>
