...
public class JacksonUtils {
    ...
    public static <T> T parseToObject(String json, Class<T> objectType) throws IOException {
        if (json == null)
            return null;
    ...
    public static <T> T parseToObject(InputStream stream, Class<T> objectType) throws IOException {
